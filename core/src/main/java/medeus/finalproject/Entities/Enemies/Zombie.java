...
/**
 * Зомби — медленный танк.
 * Много HP, медленно идёт, урон средний, кулдаун удара большой.
 */
public class Zombie extends EnemyAbstract {
    ...
    protected void loadStats() {
        hp            = 100;    // много HP
        attack        = 12;     // средний урон
        speed         = 55f;    // медленный
        attackCooldown = 2.0f;  // редко бьёт
    }

    @Override
    protected void loadAnimation() {
        // Walk — Down/Up/Left/Right (строки 0/1/2/3)
        spriteSheet = new Texture("Спрайты/Зомби спрайты/Zombie_walk.png");
        ...
        // Attack — 10 фреймов
        attackSpriteSheet = new Texture("Спрайты/Зомби спрайты/Zombie_attack.png");
        ...
        attackAnimDuration = atkCount * 0.10f; // 1.0с
    }
}
